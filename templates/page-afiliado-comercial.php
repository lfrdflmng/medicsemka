...
$page_vars = get_post_custom( get_page_by_path('comercio-afiliado')->ID );
	...
	<div class="popup-holder popup-afiliate">
		<div class="content">
			...
			<form id="frm_afiliates" class="form-horizontal">
				<input type="hidden" name="medicsemka_type" value="comercio">
	...
	<div class="popup-holder popup-pay">
		...
		<div class="content">
			<form id="frm_payment" class="form-horizontal" enctype="multipart/form-data" action="<?php echo get_template_directory_uri(); ?>/inc/create-afiliado.php">
				<?php $_COLOR = 'orange'; require('payment-form.php'); ?>
			</form>
		</div>
	</div>
...
<?php
	...
	$thank_you_page = append_var_to_url(get_page_by_path('gracias')->guid, 'p', 'comercio');
	$GLOBALS['script'] = <<<EOT
